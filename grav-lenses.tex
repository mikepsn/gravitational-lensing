...
\begin{figure}
    ...
    \label{fig:milky-way} 
    \begin{center}
        \includegraphics[width=0.9\columnwidth]{Pics/milky.eps} \\[0.2cm] 
        \includegraphics[width=0.9\columnwidth]{Pics/milky3e30.eps} 
    \end{center}
\end{figure}
...
\begin{figure}
    ...
    \label{fig:pleiades} 
    \begin{center}
        \includegraphics[width=0.9\columnwidth]{Pics/pl.eps} \\[0.2cm] 
        \includegraphics[width=0.9\columnwidth]{Pics/pl2e30.eps} 
    \end{center}
\end{figure}
